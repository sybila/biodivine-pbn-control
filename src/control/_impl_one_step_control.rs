...
impl PerturbationGraph {
    ...
    pub fn one_step_control(&self, source: &ArrayBitVector, target: &ArrayBitVector) -> ControlMap {
        /*
...
mod tests {
    ...
    fn test_trivial_one_step_control(model_file: &str) {
        ...
        for target in attractors.iter().skip(1) {
            ...
            let control = perturbations.one_step_control(&source_state, &target_state);
            println!(
