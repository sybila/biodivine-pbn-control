...
mod tests {
    ...
    fn test_trivial_temporary_control(model_file: &str) {
        ...
        for target in attractors.iter().skip(1) {
            ...
            let control = perturbations.temporary_control(&source_state, &perturbations.vertex(&target_state), perturbations.unit_colors());
            println!(
            ...
            let one_step_control = perturbations.one_step_control(&source_state, &perturbations.vertex(&target_state), perturbations.unit_colors());
