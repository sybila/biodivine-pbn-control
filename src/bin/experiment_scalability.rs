...
fn main() {
    ...
    let result = PerturbationGraph::phenotype_permanent_control(&perturbation_graph, phenotype, PhenotypeOscillationType::Allowed, perturbation_graph.mk_unit_colored_vertices().vertices().clone(), false);
